function [recorder,samples,label1, P1, label2, P2,calc_time] = Real_Time_Recording(Fs, durationSecs, modelSpeech_Non,modelSpeech_Abuse,KNN_Non,KNN_Abuse,filter_dec1,filter_dec2) 

    % load modelSpeech_Non & modelSpeech_Abuse model
    [Features1, FeatureStats1, Feature_Names1, classNames1, MEAN1, STD1, Statistics1,stWin1, stStep1, mtWin1, mtStep1] = kNN_model_load(modelSpeech_Non);
    [Features2, FeatureStats2, Feature_Names2, classNames2, MEAN2, STD2, Statistics2,stWin2, stStep2, mtWin2, mtStep2] = kNN_model_load(modelSpeech_Abuse);
    ...
    recorder = audiorecorder(Fs,16,1);% create the audio recorder The number of bits shall be 16 which is what I use for training datasets
    ...
    set(hAxes2.Title,'String','SpeechNon-Speech Classification');
    set(hAxes2.XLabel,'String','Time(s)');
    set(hAxes2.YLabel,'String','Probability');
    set(hAxes3.Title,'String','Abusive SpeechNormal Speech Classification');
    ...
    function audioTimerCallback(hObject,~)
        ...
        [prob1,lab1] = NewClassification(Data, Fs, KNN_Non, modelSpeech_Non, Features1, Feature_Names1, MEAN1, STD1, Statistics1, stWin1, stStep1, mtWin1, mtStep1,2,filter_dec1); % set Normarlize as 2
        label1{atTimSecs} = classNames1{lab1};
        P1(atTimSecs,:) = prob1;
        if strcmpi(classNames1{lab1}, 'Speech') % I need to check if this is abusive speech
            [prob2,lab2] = NewClassification(Data, Fs, KNN_Abuse, modelSpeech_Abuse, Features2, Feature_Names2, MEAN2, STD2, Statistics2, stWin2, stStep2, mtWin2, mtStep2,2,filter_dec2); % set Normarlize as 2
        ...
        %annotation('textbox',[0.15 0.65 0.3 0.15],'String',label2{atTimSecs});
        %set(hPlot1.text, 'String', myString);
