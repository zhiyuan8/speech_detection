function [recorder,samples,label1, P1, label2, P2,  calc_time] = ...
    Real_Time_SVM (Fs, nbit, durationSecs, modelSpeech_Non,KNN_Non,modelSpeech_Abuse,svmSpeech_Abuse,filter_dec1,filter_dec2) 
    ...
    function audioTimerCallback(hObject,~)
        ...
        if strcmpi(classNames1{lab1}, 'Speech') % I need to check if this is abusive speech
            [prob2,lab2] = svmClassification(Data, Fs, svmSpeech_Abuse, Feature_Names2, MEAN2, STD2, Statistics2, stWin2, stStep2, mtWin2, mtStep2,filter_dec2);
